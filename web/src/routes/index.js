      ...
      <Router>
          {/* <div> */}
           ...
           <Route exact path="/" component={Main} />
              ...
              <Route exact path="/caramelit_new/courses/uicourses" component={MainFrontend} />
              <Route exact path="/caramelit_new/courses/backend" component={MainBackEnd} />
               <Route exact path="/caramelit_new/courses/functionaltesting" component={MainFt} />
              <Route exact path="/caramelit_new/courses/fullstack" component={MainFullstack} />
              <Route exact path="/caramelit_new/courses/mobility" component={MainMobility} />
             <Route exact path="/caramelit_new/courses/devops" component={MainDevops} />
             <Route exact path="/caramelit_new/courses/datascience" component={MainDataSci} />
             <Route exact path="/caramelit_new/courses/cloud" component={MainCloudComputing} />
             <Route exact path="/caramelit_new/courses/cyber" component={MainCyber} />
             <Route exact path="/caramelit_new/courses/digital" component={MainDigMar} />
             <Route exact path="/caramelit_new/courses/erp" component={MainERP} />
             <Route exact path="/caramelit_new/courses/it" component={MainIT} />
             <Route exact path="/caramelit_new/courses/itcertification" component={MainItCertification} />

             <Route exact path='/lms/user/login' component={SignIn} /> 
          ...
          <Route exact path='/lms/instructor/instructor_login' component={SignIn2} />
          <Route exact path='/lms/organisation/organisation_login' component={SignIn3} />
          <Route exact path='/lms/admin/admin_login' render={()=> <div><BackGround ><SignIn4 /></BackGround></div> } />
          ...
          <Route exact path='/lms/instructor/dashboard' component={InstructorDashboard} />
          <Route exact path='/lms/college/dashboard' component={CollegeDashboard} />
          <Route exact path='/lms/organisations/dashboard' component={OrganisationDashboard} />
